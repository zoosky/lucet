...
mod module_data {
    ...
    fn exported_import() {
        ...
        let c = Compiler::new(&m, OptLevel::SpeedAndSize, &b, h, false)
    ...
    fn fibonacci() {
        ...
        let h = HeapSettings::default();
        let c =
            Compiler::new(&m, OptLevel::SpeedAndSize, &b, h, false).expect("compiling fibonacci");
        let mdata = c.module_data().unwrap();
        assert_eq!(mdata.globals_spec().len(), 0);
    ...
    fn arith() {
        ...
        let h = HeapSettings::default();
        let c = Compiler::new(&m, OptLevel::SpeedAndSize, &b, h, false).expect("compiling arith");
        let mdata = c.module_data().unwrap();
        assert_eq!(mdata.globals_spec().len(), 0);
    ...
    fn icall_import() {
        ...
        .unwrap();
        let h = HeapSettings::default();
        let c = Compiler::new(&m, OptLevel::SpeedAndSize, &b, h, false).expect("compile icall");
        let mdata = c.module_data().unwrap();
    ...
    fn icall_sparse() {
        ...
        let h = HeapSettings::default();
        let c =
            Compiler::new(&m, OptLevel::SpeedAndSize, &b, h, false).expect("compile icall_sparse");
        let _module_data = c.module_data().unwrap();
    ...
    fn heap_spec_import() {
        ...
        let b = Bindings::empty();
        let h = HeapSettings::default();
        let c = Compiler::new(&m, OptLevel::SpeedAndSize, &b, h.clone(), false)
    ...
    fn start_section() {
        ...
        let h = HeapSettings::default();
        let _c =
            Compiler::new(&m, OptLevel::SpeedAndSize, &b, h, false).expect("compile start_section");
        /*
        assert!(
